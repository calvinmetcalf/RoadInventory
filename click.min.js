[].indexOf||(Array.prototype.indexOf=function(a,b,c){for(c=this.length,b=(c+~~b)%c;b<c&&(!(b in this)||this[b]!==a);b++);return b^c?b:-1;});function toGeoJSON(data,cb){
...
lc.addTo(m);var clickable = L.geoJson("",{style:{opacity:0}}).addTo(m)
